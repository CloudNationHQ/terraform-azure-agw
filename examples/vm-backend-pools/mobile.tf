    ...
    backend_address_pools = {
      mobile = {
        ...
        network_interfaces = {
          ...
          vm2 = {
            network_interface_id  = module.vms.vm2.network_interfaces.vm2-int1.id
            ip_configuration_name = module.vms.vm2.network_interfaces.vm2-int1.ip_configuration[0].name
          }
        }
      }
    }
